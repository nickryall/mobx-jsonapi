...
var Collection = (_class = function () {
  function Collection(data) {
    ...
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { related: {} };
    ...
    this.meta = _mobx.observable.map({});
    this.links = _mobx.observable.map({});
  ...
  _createClass(Collection, [{
    ...
    value: function setModels() {
      ...
      if (options.remove) {
        ...
        this.spliceModels((0, _lodash8.default)(this.modelIds(), ids));
      }
      ...
      models.forEach(function (data) {
        ...
        if (!model && options.add) _this2.pushModels(data);
      });
    }
  ...
  enumerable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class.prototype, 'length', [_mobx.computed], Object.getOwnPropertyDescriptor(_class.prototype, 'length'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'setRequestLabel', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'setRequestLabel'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'set', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'set'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'setLinks', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'setLinks'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'setMeta', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'setMeta'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'setModels', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'setModels'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'setIncluded', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'setIncluded'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'addModels', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'addModels'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'pushModels', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'pushModels'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'removeModels', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'removeModels'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'spliceModels', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'spliceModels'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'fetch', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'fetch'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'create', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'create'), _class.prototype)), _class);
