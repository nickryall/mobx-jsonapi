...
var Collection = (_class = function () {
  function Collection() {
    ...
    if (!(0, _lodash4.default)(options.initialState)) {
  ...
  _createClass(Collection, [{
    ...
    value: function setModels() {
      ...
      if (options.remove) {
        ...
        this.removeModels((0, _lodash6.default)(this.modelIds(), ids));
      }
    ...
    value: function fetch() {
      ...
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { add: true, change: true, remove: true };
      ...
      return new Promise(function (resolve, reject) {
        ...
        _axios2.default.get(url, {
          ...
          _this6.set(response.data, { add: options.add, change: options.change, remove: options.remove });
