...
var Model = (_class = function () {
  function Model(data) {
    ...
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { collection: null, related: {} };
    ...
    this.relationships = _mobx.observable.map({});
    this.fetching = true;
    this.saving = false;
    this.deleting = false;
      ...
      return new Promise(function (resolve, reject) {
        _axios2.default.delete(_this5.url()).then(function (response) {
          if (options.wait && _this5.collection) {
            _this5.collection.removeModels(_this5);
          }
          ...
          if (!options.wait && _this5.collection) {
            _this5.collection.addModels(_this5);
          }
