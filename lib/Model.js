...
var Model = (_class = (_temp = _class2 = function () {
  ...
  function Model() {
    ...
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { parent: null, initialState: {}, childStores: {} };
    ...
    if (!(0, _lodash4.default)(options.childStores)) {
      Object.keys(options.childStores).forEach(function (key) {
        if (options.childStores[key]) {
          // Store reference to child
          _this[key] = options.childStores[key];
          // Store reference to this on child as 'parent' property
          options.childStores[key].parent = _this;
        }
      });
    }
  ...
  _createClass(Model, [{
    ...
    value: function url() {
      ...
      var base = (0, _lodash6.default)(this.constructor, 'url') || (0, _lodash6.default)(this.constructor, 'urlRoot') || (0, _lodash6.default)(this.parent, 'url') || urlError();
    ...
    value: function destroy() {
      ...
      if (this.isNew && (0, _lodash2.default)(this.parent.remove)) {
        this.parent.remove(this);

        return true;
      }

      if (!options.wait && (0, _lodash2.default)(this.parent.remove)) {
        this.parent.remove(this);
      } else {
      ...
      return new Promise(function (resolve, reject) {
        _axios2.default.delete(_this5.url()).then(function (response) {
          if (options.wait && (0, _lodash2.default)(_this5.parent.remove)) {
            _this5.parent.remove(_this5);
          }
          ...
          if (!options.wait && (0, _lodash2.default)(_this5.parent.add)) {
            _this5.parent.add(_this5);
          }
  ...
  return Model;
}(), _class2.urlRoot = '', _class2.type = '', _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'fetching', [_mobx.observable], {
  enumerable: true,
  initializer: null
